...
return {
  ...
  opts = {
    keymaps = {
      ...
      { "ga", description = "Git tab: stage file (git add)", filters = { ft = "neo-tree" } },
      { "gu", description = "Git tab: unstage file", filters = { ft = "neo-tree" } },
      { "gt", description = "Git tab: toggle file staged / unstaged", filters = { ft = "neo-tree" } },
      { "gr", description = "Git tab: discard changes to file (git revert)", filters = { ft = "neo-tree" } },
